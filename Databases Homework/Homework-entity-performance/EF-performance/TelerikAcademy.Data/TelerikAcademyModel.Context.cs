...
namespace TelerikAcademy.Data
{
    ...
    public partial class TelerikAcademyEntities : DbContext
    {
        ...
        public virtual ObjectResult<usp_SelectSeniorEmployees_Result> usp_SelectSeniorEmployees(Nullable<int> years)
        {
            var yearsParameter = years.HasValue ?
                new ObjectParameter("years", years) :
                new ObjectParameter("years", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SelectSeniorEmployees_Result>("usp_SelectSeniorEmployees", yearsParameter);
        }
    }
}
